                            ...
                            <div class="table-responsive">
                                <table class="table text-nowrap">
                                    ...
                                    <tr v-for="(item, index) of samples" :key="index">
                                        ...
                                        <td v-for="(item1, index1) of item.dynamic_fields" :key="index1" v-bind:style=" (item1 == 'Approved' || item1 == 'Yes') ? 'background: green;' : item1 == 'Rejected' ? 'background: red;' :  'background: none;' ">{{ item1 }}</td>
                                        <td>{{ item.finish }}</td>
                                        <td>{{ item.manufacturer }}</td>
