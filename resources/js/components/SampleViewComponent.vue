...
export default {
    ...
    data() {
        return {
            ...
            projectName: '',
            fileRecords: [],
            uploadUrl: 'http://18.118.37.62/api/samples/sampleTypePhotoUpload/'+this.$route.params.id,
    ...
    methods: {
        exportSample() {
            window.open(
                'http://18.118.37.62/projectExport?type=sample&id='+this.$route.params.id,
                '_blank'
            );
        },
        getPermission() {
        ...
        changeUploadUrl(type) {
            if(type == 'sample_type') {
                this.uploadUrl = 'http://18.118.37.62/api/samples/sampleTypePhotoUpload/'+this.$route.params.id;
            } else {
                this.uploadUrl ='http://18.118.37.62/api/samples/techDataPhotoUpload/'+this.$route.params.id;
            }
        },
        getUserList() {
