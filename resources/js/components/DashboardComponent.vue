                    ...
                    <div class="white-box">
                        <div class="d-md-flex mb-3">
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-2 ms-auto">
                                <b-button v-if="add_user && currentUserRole != 'superadmin@gmail.com'" v-b-modal="'user-add'">Add User</b-button>
                            </div>
...
export default {
    ...
    data() {
        return {
            currentUserRole : JSON.parse(localStorage.getItem('user')).email,
            add_user: false,
            delete_user: false,
            edit_user: false,
            pagination: {},
